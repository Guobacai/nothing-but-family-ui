...
import { useGetRecordsQuery, useDeleteRecordMutation } from '../../api/app';
...
export default function Spending() {
  ...
  return (
    <div>
      ...
      {isOpen && (
        <div className="mm-absolute mm-top-0 mm-left-0 mm-w-screen mm-h-screen mm-bg-neutral-200 mm-z-[200] mm-opacity-60"></div>
      )}
      <div
        className={clsx(
